...
from courses.forms import BlogpostForm
from courses.models import Blogpost
from courses.services import get_cache_blogposts
...
class BlogpostCreateView(
    ...
    success_url = reverse_lazy('courses:post_list')
    permission_required = 'courses.add_blogpost'
...
class BlogpostUpdateView(
    ...
    model = Blogpost
    form_class = BlogpostForm
    permission_required = 'courses.change_blogpost'
    ...
    def get_success_url(self):
        return reverse('courses:post_view', args=[self.object.pk])
...
class BlogpostDeleteView(
    ...
    model = Blogpost
    success_url = reverse_lazy('courses:post_list')
    permission_required = 'courses.delete_blogpost'
